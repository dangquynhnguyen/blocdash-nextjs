				...
				<Container style={container}>
					<Section style={coverSection}>
						<Section style={imageSection}>
							<Img src="/logo.svg" width="75" height="45" alt="Logo" />
						</Section>
						<Section style={upperSection}>
							<Heading style={h1}>Reset your password</Heading>
							<Text style={mainText}>
								We've received a request to reset the password for the Blocdash account associated
								with {toMail}. No changes have been made to your account yet. To reset your
						...
						<Section style={lowerSection}>
							<Text style={cautionText}>
								Blocdash will never email you and ask you to disclose or verify your password,
